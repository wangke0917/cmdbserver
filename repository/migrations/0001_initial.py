# -*- coding: utf-8 -*-
# Generated by Django 1.11.9 on 2019-05-16 11:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_detail', models.CharField(blank=True, max_length=256, null=True, verbose_name='设置详细配置')),
        ...
        migrations.AddField(
            ...
            name='users',
            field=models.ManyToManyField(to='repository.UserInfo'),
        ),
        migrations.AddField(
            model_name='nic',
            name='server',
        ...
        migrations.AddField(
            ...
            name='creator',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='repository.UserInfo'),
        ),
        migrations.AddField(
            model_name='asset',
            name='business_unit',
