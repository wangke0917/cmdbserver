...
class NetworkDevice(models.Model):
    ...
    manufacture = models.CharField('制造商', max_length=128, null=True, blank=True)
    model = models.CharField('型号', max_length=128, null=True, blank=True)
    port_num = models.SmallIntegerField('端口个数', null=True, blank=True)
    device_detail = models.CharField('设置详细配置', max_length=256, null=True, blank=True)
...
class Server(models.Model):
    asset = models.OneToOneField('Asset')
    hostname = models.CharField(max_length=32, verbose_name='主机名', unique=True)
